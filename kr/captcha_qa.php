...
$lang = array_merge($lang, array(
	...
	'EDIT_QUESTION'				=> '질문 수정',
	'QUESTIONS'					=> '질문',
	'QUESTIONS_EXPLAIN'			=> 'Q&amp;A 플러그인을 당신이 사용하도록 모든 형태의 설정을 제출하십시오, 유저는 여기에 지정된 질문 중 하나를 수행하라는 메시지가 표시됩니다. 적어도 하나의 기본 언어를 설정해야 플러그인을 사용합니다. 구글 검색을 위해 이러한 질문은 구글 검색 봇이 대답하기 쉽게 넘어가게 해야합니다. 질문의 설정을 불규칙하게 변경하여 사용하는 것이 가장 좋은 결과를 얻을 것입니다 . 당신의 질문이 혼합 된 경우에 의존하는 경우에는 엄격한 설정을 사용합니다, 문장 부호 또는 공백.',
