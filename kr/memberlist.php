...
$lang = array_merge($lang, array(
	...
	'EMAIL_TOPIC_EXPLAIN'	=> '이 메시지는 HTML이나 BBCode는 포함되어 있지 않습니다, 일반 텍스트로 전송됩니다. 주제 정보가 이미 메시지에 포함되어 있습니다. 이 메시지에 대한 리턴 주소는 이메일 주소로 설정됩니다.',
	...
	'FIND_USERNAME_EXPLAIN'	=> '특정 구성원을 검색하려면이 양식을 사용하십시오. 당신은 모든 필드를 기입 할 필요가 없습니다. 와일드 카드로 일부 데이터 사용 *과 일치합니다. 입력 날짜 형식을 사용하는 경우 <kbd>YYYY-MM-DD</kbd>, e.g. <samp>2004-02-29</samp>.여러 사용자 이름은 양식 자체에 따라 인정할 수있다) 하나 이상의 사용자 이름을 선택하고 이전의 형태로 돌아 선택 마크 된 버튼을 클릭 마크 체크 박스를 사용합니다.',
	...
	'IM_JABBER'				=> '사용자가 원치 않는 인스턴트 메시지를 수신하지 않도록 선택했을 수 있습니다.',
	'IM_JABBER_SUBJECT'		=> '자동 메시지이므로 회신하지마시기바랍니다! %2$s의 사용자 %1$s의 메시지.',
	'IM_MESSAGE'			=> '당신의 메시지',
	'IM_NAME'				=> '당신의 이름',
	'IM_NO_DATA'			=> '이 사용자에 대한 적절한 연락처 정보가 없습니다.',
	'IM_NO_JABBER'			=> '죄송합니다, 재버 사용자의 직접 메시징은이 보드에서 지원되지 않습니다. 당신은 위의받는 사람에게 연락하는 시스템에 설치 재버 클라이언트가 필요합니다.',
	'IM_RECIPIENT'			=> '받는 사람',
	'IM_SEND'				=> '메시지 보내기',
	...
	'LOGIN_EXPLAIN_TEAM'		=> '이 보드는 등록 팀 목록을 보려면 로그인해야합니다.',
	'LOGIN_EXPLAIN_MEMBERLIST'	=> '이 보드는 등록 멤버에 액세스하려면 로그인해야합니다.',
	'LOGIN_EXPLAIN_SEARCHUSER'	=> '이 보드는 등록 된 사용자를 검색하려면 로그인해야합니다.',
	'LOGIN_EXPLAIN_VIEWPROFILE'	=> '이 보드는 등록 프로필을 보려면 로그인해야합니다.',

	'MORE_THAN'				=> '이상',

	'NO_CONTACT_FORM'		=> '게시판 관리자 연락처 양식은 사용할 수 없습니다.',
	'NO_CONTACT_PAGE'		=> '보드 관리자 연락처 페이지는 사용할 수 없습니다.',
