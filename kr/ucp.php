...
$lang = array_merge($lang, array(
	...
	'CURRENT_PASSWORD_EXPLAIN'	=> '당신이 이메일 주소 혹은 유저 이름을 변경하고자 하는 경우에는 현재 암호를 입력해야합니다.',
	'CURRENT_CHANGE_PASSWORD_EXPLAIN' => '비밀번호, 이메일 주소 또는 유저 이름을 변경하려면 현재 암호를 입력해야합니다.',
	...
	'EMAIL_REMIND'				=> '이 귀하의 계정과 연결된 이메일 주소 여야합니다. 당신이 당신의 유저 제어판을 통해이 변경되지 않은 경우, 그것은 당신이 귀하의 계정에 등록 된 이메일 주소입니다.',
	...
	'FOES_EXPLAIN'				=> '싫어하는 친구는 기본적으로 무시되는 유저입니다. 이러한 유저의 게시물이 완전히 표시되지 않습니다. 싫어하는 친구에게 비밀 메시지는 여전히 허용됩니다. 운영자 또는 관리자도 무시됩니다.',
	...
	'FOLDER_STATUS_MSG'			=> array(
		1	=> '폴더는  %3$d%% 꽉참 (%2$d 중 %1$s 저장됨)',
		2	=> '폴더는 %3$d%% 꽉참 (%2$d 중 %1$s 저장됨)',
	),
	'FORWARD_PM'				=> 'PM 앞으로',
	'FORCE_PASSWORD_EXPLAIN'	=> '당신이 게시물을 찾아 계속하기 전에 당신은 암호를 변경해야합니다.',
	...
	'LOGIN_EXPLAIN_UCP'			=> '유저 제어판에 액세스하려면 로그인하십시오.',
	...
	'MAX_FOLDER_REACHED'			=> '허용 사용자 정의 폴더의 최대 수에 도달했습니다.',
	'MESSAGE_BY_AUTHOR'				=> '로',
