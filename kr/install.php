...
$lang = array_merge($lang, array(
	...
	'ADMIN_PASSWORD_EXPLAIN'	=> '길이 6과 30 자 사이의 암호를 입력하십시오.',
	'ADMIN_TEST'				=> '관리자 세팅 체크',
	'ADMIN_USERNAME'			=> '관리자 유저이름',
	'ADMIN_USERNAME_EXPLAIN'	=> '길이 3과 20 자 사이의 사용자 이름을 입력하세요.',
	'APP_MAGICK'				=> 'Imagemagick 지원 [ Attachments ]',
	'AUTHOR_NOTES'				=> '저자 노트<br />» %s',
	'AVAILABLE'					=> '사용 가능',
	'AVAILABLE_CONVERTORS'		=> '사용 가능한 컨버터',

	'BEGIN_CONVERT'					=> '변환 시작',
	'BLANK_PREFIX_FOUND'			=> '테이블을 스캔하여 테이블 접두사를 사용한 유효한 설치를 보이고 있다',
	'BOARD_NOT_INSTALLED'			=> '설치를 찾을수 없음',
	'BOARD_NOT_INSTALLED_EXPLAIN'	=> 'phpBB를 통합 변환기 프레임 워크가 작동하는 phpBB3의 기본 설치가 필요합니다,<a href="%s">처음 설치하는 phpBB3에 의해 진행됩니다.</a>.',
	'BACKUP_NOTICE'					=> '문제는 업데이트 과정에서 발생하는 경우에 발생하기때문에 업데이트하기 전에 게시판를 백업하시기 바랍니다.',

	'CATEGORY'					=> '카테고리',
	'CACHE_STORE'				=> '캐시 타입',
	'CACHE_STORE_EXPLAIN'		=> '데이터가 캐시에 저장되는 물리적 위치는, 파일 시스템이 바람직합니다.',
	'CAT_CONVERT'				=> '변환',
	'CAT_INSTALL'				=> '설치',
	'CAT_OVERVIEW'				=> '개요',
	'CAT_UPDATE'				=> '업데이트',
	'CHANGE'					=> '변경',
	'CHECK_TABLE_PREFIX'		=> '당신의 테이블 접두사 체크하고 다시 시도해주십시오.',
	'CLEAN_VERIFY'				=> '정리 및 최종 구조를 확인',
	'CLEANING_USERNAMES'		=> '사용자 이름을 청소',
	'COLLIDING_CLEAN_USERNAME'	=> '<strong>%s</strong> 대한 클린한 이름은 다음과 같습니다:',
...
$lang = array_merge($lang, array(
	...
	'VIEWING_FILE_CONTENTS'			=> '파일 컨텐츠 보기',
	'VIEWING_FILE_DIFF'				=> '파일 차이 보기',

	'WRONG_INFO_FILE_FORMAT'	=> '잘못된 파일 형식 정보',
));

// Default database schema entries...
$lang = array_merge($lang, array(
	'CONFIG_BOARD_EMAIL_SIG'		=> '감사합니다, 관리',
	'CONFIG_SITE_DESC'				=> '짧은 텍스트는 포럼을 설명하기 위해있습니다',
	'CONFIG_SITENAME'				=> '당신의 도메인.com',

	'DEFAULT_INSTALL_POST'			=> '이것은 당신의 phpBB3 설치의 예를 들은 게시물입니다. 모든 작동하는 것 같습니다. 당신은 당신이 좋아하는 경우에이 게시물을 삭제하고 보드 설정을 계속할 수 있습니다. 설치 과정에서 첫 번째 범주와 첫 번째 포럼은 사용자 그룹 관리자, 봇, 글로벌 사회자, 손님, 등록 된 사용자 및 등록 COPPA 사용자 미리 정의 된 권한의 적절한 설정이 할당됩니다. 당신은 또한 당신의 첫 번째 범주와 첫 번째 포럼을 삭제하도록 선택하는 경우, 사용자가 만든 모든 새 범주와 포럼에 대한 모든 사용자 그룹에 대한 권한을 할당하는 것을 잊지 마세요. 그것은 새로운 범주와 포럼을 만드는 동안 첫 번째 범주와 이들에서 첫 번째 포럼 및 복사 권한의 이름을 변경하는 것이 좋습니다. 재미있게 즐기십시오!',

	'FORUMS_FIRST_CATEGORY'			=> '당신의 첫 카테고리',
	'FORUMS_TEST_FORUM_DESC'		=> '당신의 첫 포럼에 대한 설명.',
	'FORUMS_TEST_FORUM_TITLE'		=> '당신의 첫 포럼',

	'RANKS_SITE_ADMIN_TITLE'		=> '사이트 관리자',
	'REPORT_WAREZ'					=> '포스트는 불법 또는 불법 복제 소프트웨어에 대한 링크가 포함되어 있습니다.',
	'REPORT_SPAM'					=> '신고 된 게시물은 웹 사이트 또는 다른 제품에 대한 광고를 한 목적이있습니다.',
	'REPORT_OFF_TOPIC'				=> '신고된 글은 글타래에서 꺼집니다.',
	'REPORT_OTHER'					=> '다른 범주에 맞지 않는보고 된 게시물은 추가 정보 필드를 사용하십시오.',
	...
	'TOPICS_TOPIC_TITLE'			=> 'phpBB3에 오신것을 환영합니다.',
));
