...
$lang = array_merge($lang, array(
	...
	'CANNOT_POST_STICKY'		=> '죄송하지만 당신은 붙박이 주제를 게시 할 수 없습니다.',
	...
	'DELETE_TOPIC_PERMANENTLY_CONFIRM'	=> '당신은  <strong>영구적으로</strong> 이 주제를 삭제 하시겠습니까?',
	'DELETE_TOPICS_CONFIRM'		=> '당신은 이 주제를 삭제 하시겠습니까?',
	'DELETE_TOPICS_PERMANENTLY_CONFIRM'	=> '당신은 <strong>영구적으로</strong> 이러한 주제를 삭제 하시겠습니까?',
	...
	'LOAD'						=> '불러오기',
	'LOAD_DRAFT'				=> '초안 불러오기',
	'LOAD_DRAFT_EXPLAIN'		=> '여기에 당신은 당신이 기록을 계속하려면 초안을 선택할 수 있습니다. 현재 게시물이 취소됩니다 현재의 모든 게시물의 내용이 삭제됩니다. 보기, 편집하고 사용자 제어판 내에서 초안을 삭제합니다.',
	'LOGIN_EXPLAIN_BUMP'		=> '이 포럼에서 주제를 범프하기 위해서는 로그인이 필요합니다.',
	...
	'LOGIN_EXPLAIN_REPLY'		=> '이 포럼에서 주제에 답변하기 위해 로그인이 필요합니다.',
	...
	'POLL_MAX_OPTIONS'			=> '사용자 당 옵션',
	'POLL_MAX_OPTIONS_EXPLAIN'	=> '이 투표 할 때마다 사용자가 선택할 수 옵션의 수입니다.',
	...
	'POLL_VOTE_CHANGE_EXPLAIN'	=> '사용이 가능한 사용자가 자신의 투표를 변경할 수있는 경우.',
	'POSTED_ATTACHMENTS'		=> '첨부 게시됨',
	'POST_APPROVAL_NOTIFY'		=> '게시물이 승인 된 경우는 통보를받을 것입니다.',
	'POST_CONFIRMATION'			=> '게시물 확인',
	'POST_CONFIRM_EXPLAIN'		=> '자동화 된 게시물을 방지하기 위해 보드는 확인 코드를 입력해야합니다. 코드는 이미지에 표시됩니다. 당신은 시각 장애인 또는 그렇지 않으면 이 코드를 읽을 수없는 경우 %s Board 관리자 %s에 문의하시기 바랍니다.',
	...
	'POST_REVIEW_EDIT_EXPLAIN'	=> '당신이 그것을 편집하는 동안 이 게시물이 다른 사용자에 의해 변경되었습니다. 당신은 이 게시물의 현재 버전을 검토하고 편집을 조정 할 수 있습니다.',
	'POST_REVIEW_EXPLAIN'		=> '적어도 하나의 새로운 게시물이 이 주제에 만들어졌습니다. 이에 비추어 게시물을 검토 할 수 있습니다.',
	'POST_STORED'				=> '이 메시지는 성공적으로 게시되었습니다.',
	'POST_STORED_MOD'			=> '이 메시지는 성공적으로 제출되었습니다, 이 공개적으로 볼 수 있습니다 전에 그러나 운영자의 승인을해야합니다.',
	'POST_TOPIC_AS'				=> '로 포스트 주제',
	'PROGRESS_BAR'				=> '진행 바',
	...
	'SMILIES'					=> 'Smilies',
	'SMILIES_ARE_OFF'			=> 'Smilies 는 <em>꺼짐</em>',
	'SMILIES_ARE_ON'			=> 'Smilies 는 <em>켜짐</em>',
	'STICKY_ANNOUNCE_TIME_LIMIT'=> '붙박이/공지 시간 제한',
	'STICK_TOPIC_FOR'			=> '에 대한 주제를 붙박음',
	'STICK_TOPIC_FOR_EXPLAIN'	=> '끝없는 붙박이/공지에는 0을 입력합니다. 이 번호는 게시물의 날짜를 기준으로 있습니다.',
	...
	'TOO_MANY_USER_OPTIONS'		=> '당신은 기존의 설문 조사 옵션보다 사용자 당 더 많은 옵션을 지정할 수 없습니다.',
	'TOPIC_BUMPED'				=> '주제는 성공적으로 충돌하고있다.',

	'UNAUTHORISED_BBCODE'		=> '당신은 어떤 BBCodes을 사용할 수 없습니다: %s.',
	'UNGLOBALISE_EXPLAIN'		=> '일반적인 주제에 글로벌되는 것을 다시 이 주제를 전환하려면, 당신은 당신이 이 항목은 표시하고자하는 포럼을 선택해야합니다.',
	'UNSUPPORTED_CHARACTERS_MESSAGE'	=> '귀하의 메시지는 다음과 지원되지 않는 문자가 포함:<br />%s',
	'UNSUPPORTED_CHARACTERS_SUBJECT'	=> '당신의 주제는 다음과 같은 지원되지 않는 문자가 포함:<br />%s',
	...
	'USER_CANNOT_BUMP'			=> '이 포럼에서 주제를 범프 수 없습니다.',
