...
$lang = array_merge($lang, array(
	...
	'LOGIN_EXPLAIN_EGOSEARCH'	=> '이 게시판은 당신이 가입하고 자신의 게시물을 보려면 로그인해야합니다.',
	'LOGIN_EXPLAIN_UNREADSEARCH'=> '이 게시판은 가입하고 읽지 않은 게시글보기를 하려면 로그인해야합니다.',
	'LOGIN_EXPLAIN_NEWPOSTS'	=> '이 게시판은 가입이후 마지막 방문 이후 새로운 게시글보기 하려면 로그인해야합니다.',
	...
	'NO_SEARCH_UNREADS'		=> '죄송하지만, 읽지 않은 게시물을 검색하면 게시판에 사용할 수 없습니다.',
	...
	'PHRASE_SEARCH_DISABLED'	=> '정확한 구문에 의해 검색이 게시판에서 지원되지 않습니다.',
	...
	'SEARCH_FIRST_POST'			=> '오직 글타래의 첫 번째 게시물',
	'SEARCH_FORUMS'				=> '포럼 검색',
	...
	'SEARCH_TITLE_MSG'			=> '포스트 글타래와 메시지 텍스트',
	'SEARCH_TITLE_ONLY'			=> '오직 글타래 재목만',
	'SEARCH_WITHIN'				=> '검색 안에',
	'SORT_ASCENDING'			=> '오름차순',
	'SORT_AUTHOR'				=> '글쓴이',
	'SORT_DESCENDING'			=> '내림차순',
	'SORT_FORUM'				=> '포럼',
	'SORT_POST_SUBJECT'			=> '글타래 쓰기',
	'SORT_TIME'					=> '시간 쓰기',
