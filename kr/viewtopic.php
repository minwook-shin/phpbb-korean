...
$lang = array_merge($lang, array(
	...
	'BOOKMARK_ADDED'		=> '글타래를 성공적으로 북마크되었습니다.',
	'BOOKMARK_ERR'			=> '글타래는 북마크하는것에 실패했습니다. 다시 시도해주세요.',
	'BOOKMARK_REMOVED'		=> '북마크된 글타래를 성공적으로 삭제했습니다.',
	'BOOKMARK_TOPIC'		=> '글타래 북마크',
	...
	'LOGIN_NOTIFY_TOPIC'	=> '글타래의 이것을 보시려면 로그인을 해주십시오.',
	'LOGIN_VIEWTOPIC'		=> '이 게시판은 항목을 보려면 가입과 로그인을 해야합니다.',

	'MAKE_ANNOUNCE'				=> '“공지”로 바꾸기',
	'MAKE_GLOBAL'				=> '“전체 공지”로 바꾸기',
	'MAKE_NORMAL'				=> '“표준 글타래”로 바꾸기',
	'MAKE_STICKY'				=> '“고정”으로 바꾸기',
	...
	'NO_NEWER_TOPICS'		=> '이 포럼에는 새로운 글타래가 없습니다.',
	...
	'REPLY_TO_TOPIC'		=> '글타래에 댓글 달기',
	'RESTORE'				=> '복원',
	'RESTORE_TOPIC'			=> '글타래 복원',
	...
	'VIEW_INFO'				=> '자세한 글',
	'VIEW_NEXT_TOPIC'		=> '새로운 글타래',
	'VIEW_PREVIOUS_TOPIC'	=> '글타래 미리보기',
	'VIEW_RESULTS'			=> '결과 보기',
	'VIEW_TOPIC_POSTS'		=> array(
		1	=> '%d 게시물',
		2	=> '%d 게시물들',
	),
	'VIEW_UNREAD_POST'		=> '처음 읽지않은 게시물',
