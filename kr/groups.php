...
$lang = array_merge($lang, array(
	...
	'GROUP_IS_CLOSED'					=> '닫힌 그룹, 신규 유저은 그룹 리더의 초청에 가입 할 수 있습니다.',
	'GROUP_IS_FREE'						=> '이것은 모든 신입 유저 환영, 자유롭게 열린 그룹입니다.',
	'GROUP_IS_HIDDEN'					=> '이 숨겨진 그룹의 구성원을 볼 수있는이 그룹의 구성원입니다.',
	'GROUP_IS_OPEN'						=> '이것은 오픈 그룹은 유저 가입 신청을 할 수있다',
	'GROUP_IS_SPECIAL'					=> '이는, 특별한 그룹은 게시판 관리자가 특별한 그룹 관리됩니다.',
	'GROUP_JOIN'						=> '그룹 가입',
	...
	'GROUP_JOINED_PENDING'				=> '성공적으로 그룹 구성원을 요청했습니다. 유저을 승인하는 그룹 리더 기다려주십시오.',
	'GROUP_LIST'						=> '유저 관리',
	...
	'GROUP_RESIGN_MEMBERSHIP_CONFIRM'	=> '당신은 당신이 선택한 그룹에서 유저을 탈퇴 하시겠습니까?',
	'GROUP_RESIGN_PENDING'				=> '보류중인 그룹 구성원을 사임',
	'GROUP_RESIGN_PENDING_CONFIRM'		=> '당신은 당신이 선택한 그룹에서 보류중인 유저을 탈퇴 하시겠습니까?',
	'GROUP_RESIGNED_MEMBERSHIP'			=> '당신이 성공적으로 선택한 그룹에서 제거되었습니다.',
	'GROUP_RESIGNED_PENDING'			=> '보류중인 유저이 성공적으로 선택한 그룹에서 제거되었습니다.',
	'GROUP_TYPE'						=> '그룹 유형',
	...
	'NOT_MEMBER_OF_GROUP'			=> '선택한 그룹의 구성원이 아니기 때문에 요청한 작업을 수행 할 수 없거나 또는 유저이 아직 승인하지 않았습니다.',
