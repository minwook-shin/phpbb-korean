...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_FRIENDS_BASIC_ANSWER'	=> 'You can use these lists to organize other members of the board. Members added to your friends list will be listed within your User Control Panel for quick access to see their online status and to send them private messages. Subject to template support, posts from these users may also be highlighted. If you add a user to your foes list, any posts they make will be hidden by default.',
	...
	'HELP_FAQ_GROUPS_COLORS_ANSWER'	=> 'It is possible for the board administrator to assign a color to the members of a usergroup to make it easy to identify the members of this group.',
	'HELP_FAQ_GROUPS_COLORS_QUESTION'	=> 'Why do some usergroups appear in a different color?',
	'HELP_FAQ_GROUPS_DEFAULT_ANSWER'	=> 'If you are a member of more than one usergroup, your default is used to determine which group color and group rank should be shown for you by default. The board administrator may grant you permission to change your default usergroup via your User Control Panel.',
